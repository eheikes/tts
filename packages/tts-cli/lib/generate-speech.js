...
exports.generateSpeech = (ctx, task) => {
  ...
  ctx.opts = Object.assign({}, {
    ...
    sampleRate: ctx.args['sample-rate'] ? Number(ctx.args['sample-rate']) : undefined,
  ...
  if (typeof ctx.opts.effect !== 'undefined' && !Array.isArray(ctx.opts.effect)) {
    ctx.opts.effect = [ctx.opts.effect]
  }
